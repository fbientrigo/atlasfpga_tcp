...
HD_PWD='C:/Users/victo/Desktop/Vivados/verDAQ8_uart/verDAQ8_uart.runs/zsys_AXI_ADC_v1_0_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log zsys_AXI_ADC_v1_0_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source zsys_AXI_ADC_v1_0_0_0.tcl

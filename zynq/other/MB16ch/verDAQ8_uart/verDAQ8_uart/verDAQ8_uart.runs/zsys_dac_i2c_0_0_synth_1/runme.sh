...
HD_PWD='C:/Users/victo/Desktop/Vivados/verDAQ8_uart/verDAQ8_uart.runs/zsys_dac_i2c_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log zsys_dac_i2c_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source zsys_dac_i2c_0_0.tcl

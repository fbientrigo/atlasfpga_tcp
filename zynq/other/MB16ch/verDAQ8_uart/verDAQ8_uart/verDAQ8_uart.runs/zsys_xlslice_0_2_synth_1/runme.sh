...
HD_PWD='C:/Users/victo/Desktop/Vivados/verDAQ8_uart/verDAQ8_uart.runs/zsys_xlslice_0_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log zsys_xlslice_0_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source zsys_xlslice_0_2.tcl

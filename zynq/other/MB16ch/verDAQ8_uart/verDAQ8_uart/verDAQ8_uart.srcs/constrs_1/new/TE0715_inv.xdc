...
#set_property -dict {PACKAGE_PIN A7 IOSTANDARD LVDS_25} [get_ports B1_DRS_REFCLK_P]
#set_property -dict {PACKAGE_PIN G1 IOSTANDARD LVCMOS25} [get_ports B1_DRS_A[2]]
#set_property -dict {PACKAGE_PIN H1 IOSTANDARD LVCMOS25} [get_ports B1_DRS_A[3]]
##set_property -dict {PACKAGE_PIN D2 IOSTANDARD LVCMOS25} [get_ports B1_DRS_DTAP]
#set_property -dict {PACKAGE_PIN E2 IOSTANDARD LVCMOS25} [get_ports B1_DRS_DWRITE]
#set_property -dict {PACKAGE_PIN D7 IOSTANDARD LVCMOS25} [get_ports B1_DRS_A[1]]
#set_property -dict {PACKAGE_PIN D6 IOSTANDARD LVCMOS25} [get_ports B1_DRS_A[0]]
#set_property -dict {PACKAGE_PIN F2 IOSTANDARD LVCMOS25} [get_ports B1_DRS_RSLOAD]
#set_property -dict {PACKAGE_PIN F1 IOSTANDARD LVCMOS25} [get_ports B1_DRS_SRCLK]
#set_property -dict {PACKAGE_PIN C3 IOSTANDARD LVCMOS25} [get_ports B1_DRS_SRIN]
#set_property -dict {PACKAGE_PIN D3 IOSTANDARD LVCMOS25} [get_ports B1_DRS_SROUT]
...
#ADC_CLK inverted polarity on B1
#set_property -dict {PACKAGE_PIN AB11 IOSTANDARD LVDS_25} [get_ports B1_ADC_CLK_N]
#set_property -dict {PACKAGE_PIN F5 IOSTANDARD LVDS_25} [get_ports B1_ADC_CLK_P]
#ADC_CH_8 inverted polarity on B1
#set_property -dict {PACKAGE_PIN AB12 IOSTANDARD LVDS_25} [get_ports B1_ADC_CH_8_N]
...
#########################
#set_property PACKAGE_PIN AA22 [get_ports B0_DAC_SEL[0]]
#set_property PACKAGE_PIN AB22 [get_ports B0_DAC_SEL[1]]
set_property -dict {PACKAGE_PIN L4 IOSTANDARD LVCMOS25} [get_ports B0_ADC_nCS]

#########################
#BOARD 1 specific signals
#########################
set_property -dict {PACKAGE_PIN AB17 IOSTANDARD LVCMOS25} [get_ports {B0_DAC_SEL[1]}]
set_property -dict {PACKAGE_PIN AB18 IOSTANDARD LVCMOS25} [get_ports {B0_DAC_SEL[0]}]
set_property -dict {PACKAGE_PIN AB19 IOSTANDARD LVCMOS25} [get_ports B0_ADC_nCS]
...
#set_property PACKAGE_PIN R6 [get_ports E-Link_TX_N]
#set_property PACKAGE_PIN T6 [get_ports E-Link_TX_P]
...
#trigger inputs
###############
#set_property PACKAGE_PIN J21 [get_ports B0_TRG[7]]
#set_property PACKAGE_PIN J22 [get_ports B0_TRG[6]]
#set_property PACKAGE_PIN J20 [get_ports B0_TRG[5]]
#set_property PACKAGE_PIN K21 [get_ports B0_TRG[4]]
#set_property PACKAGE_PIN R19 [get_ports B0_TRG[3]]
#set_property PACKAGE_PIN T19 [get_ports B0_TRG[2]]
#set_property PACKAGE_PIN N20 [get_ports B0_TRG[1]]
#set_property PACKAGE_PIN N19 [get_ports B0_TRG[0]]

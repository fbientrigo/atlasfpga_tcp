...
BEGIN DRIVER
 PARAMETER DRIVER_NAME = Mult_ADC_AXI
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = ADC_Mult_ADC_AXI_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = CPLD_ctrl
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = CPLD_ctrl_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = DRS4_firmware
 PARAMETER DRIVER_VER = 2.0
 PARAMETER HW_INSTANCE = DRS4_firmware_1
END
...
BEGIN DRIVER
 PARAMETER DRIVER_NAME = clk_mon
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = clk_mon_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = dac_i2c
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = dac_i2c_0
END

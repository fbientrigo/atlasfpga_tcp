...
HD_PWD='c:/users/victo/desktop/vivados/cmb40_v1/cmb40_v1.tmp/axi_adc_v1_0_v2_0_project/AXI_ADC_v1_0_v2_0_project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log AXI_ADC_v1_0.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source AXI_ADC_v1_0.tcl -notrace

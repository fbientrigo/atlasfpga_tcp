...
HD_PWD='c:/users/victo/desktop/vivados/cmb40_v1/cmb40_v1.tmp/axi_adc_v1_0_v2_0_project/AXI_ADC_v1_0_v2_0_project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log AXI_ADC_v1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source AXI_ADC_v1_0.tcl

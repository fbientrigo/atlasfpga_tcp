...
-- Command     : write_vhdl -force -mode funcsim -rename_top zsys_fit_timer_0_0 -prefix
--               zsys_fit_timer_0_0_ zsys_fit_timer_0_0_sim_netlist.vhdl
...
entity zsys_fit_timer_0_0_Divide_part is
  port (
    ...
    \not_First.Out1_reg_8\ : out STD_LOGIC;
    Clk : in STD_LOGIC;
    Rst : in STD_LOGIC;
    ...
    loop_Bit_9 : in STD_LOGIC
  );
end zsys_fit_timer_0_0_Divide_part;

architecture STRUCTURE of zsys_fit_timer_0_0_Divide_part is
  signal \One_SRL16.SRL16E_I_i_1__9_n_0\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \One_SRL16.SRL16E_I_i_1__9\ : label is "soft_lutpair0";
...
\One_SRL16.SRL16E_I_i_1__9\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"0E"
    )
        port map (
...
\One_SRL16.SRL16E_I_i_2__8\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"0E"
    )
        port map (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity \zsys_fit_timer_0_0_Divide_part__parameterized0\ is
  port (
    loop_Bit : out STD_LOGIC;
    Clk_En_I_9 : out STD_LOGIC;
    CE : out STD_LOGIC;
    CE_0 : in STD_LOGIC;
  ...
  attribute ORIG_REF_NAME of \zsys_fit_timer_0_0_Divide_part__parameterized0\ : entity is "Divide_part";
end \zsys_fit_timer_0_0_Divide_part__parameterized0\;

architecture STRUCTURE of \zsys_fit_timer_0_0_Divide_part__parameterized0\ is
  signal \^clk_en_i_9\ : STD_LOGIC;
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity \zsys_fit_timer_0_0_Divide_part__parameterized1\ is
  port (
    loop_Bit : out STD_LOGIC;
    ...
    Rst : in STD_LOGIC;
    Rst_d1 : in STD_LOGIC;
    Clk_En_I_9 : in STD_LOGIC
  );
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of \zsys_fit_timer_0_0_Divide_part__parameterized1\ : entity is "Divide_part";
end \zsys_fit_timer_0_0_Divide_part__parameterized1\;

architecture STRUCTURE of \zsys_fit_timer_0_0_Divide_part__parameterized1\ is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity \zsys_fit_timer_0_0_Divide_part__parameterized2\ is
  port (
    loop_Bit : out STD_LOGIC;
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of \zsys_fit_timer_0_0_Divide_part__parameterized2\ : entity is "Divide_part";
end \zsys_fit_timer_0_0_Divide_part__parameterized2\;

architecture STRUCTURE of \zsys_fit_timer_0_0_Divide_part__parameterized2\ is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity \zsys_fit_timer_0_0_Divide_part__parameterized2_0\ is
  port (
    loop_Bit : out STD_LOGIC;
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of \zsys_fit_timer_0_0_Divide_part__parameterized2_0\ : entity is "Divide_part";
end \zsys_fit_timer_0_0_Divide_part__parameterized2_0\;

architecture STRUCTURE of \zsys_fit_timer_0_0_Divide_part__parameterized2_0\ is
  signal \^interrupt\ : STD_LOGIC;
  signal \^loop_bit\ : STD_LOGIC;
  signal \not_First.Clk_En_Out_i_i_1__8_n_0\ : STD_LOGIC;
  signal \not_First.Out1_reg_n_0\ : STD_LOGIC;
  attribute box_type : string;
  attribute box_type of \One_SRL16.SRL16E_I\ : label is "PRIMITIVE";
  attribute srl_bus_name : string;
  attribute srl_bus_name of \One_SRL16.SRL16E_I\ : label is "U0/\Using_SRL16s.SRL16s ";
  attribute srl_name : string;
  attribute srl_name of \One_SRL16.SRL16E_I\ : label is "U0/\Using_SRL16s.SRL16s[11].Divide_I/One_SRL16.SRL16E_I ";
begin
  Interrupt <= \^interrupt\;
  loop_Bit <= \^loop_bit\;
\One_SRL16.SRL16E_I\: unisim.vcomponents.SRL16E
...
\not_First.Clk_En_Out_i_i_1__8\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"B8"
    )
        port map (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity \zsys_fit_timer_0_0_Divide_part__parameterized2_1\ is
  port (
    loop_Bit : out STD_LOGIC;
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of \zsys_fit_timer_0_0_Divide_part__parameterized2_1\ : entity is "Divide_part";
end \zsys_fit_timer_0_0_Divide_part__parameterized2_1\;

architecture STRUCTURE of \zsys_fit_timer_0_0_Divide_part__parameterized2_1\ is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity \zsys_fit_timer_0_0_Divide_part__parameterized2_2\ is
  port (
    loop_Bit : out STD_LOGIC;
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of \zsys_fit_timer_0_0_Divide_part__parameterized2_2\ : entity is "Divide_part";
end \zsys_fit_timer_0_0_Divide_part__parameterized2_2\;

architecture STRUCTURE of \zsys_fit_timer_0_0_Divide_part__parameterized2_2\ is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity \zsys_fit_timer_0_0_Divide_part__parameterized2_3\ is
  port (
    loop_Bit : out STD_LOGIC;
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of \zsys_fit_timer_0_0_Divide_part__parameterized2_3\ : entity is "Divide_part";
end \zsys_fit_timer_0_0_Divide_part__parameterized2_3\;

architecture STRUCTURE of \zsys_fit_timer_0_0_Divide_part__parameterized2_3\ is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity \zsys_fit_timer_0_0_Divide_part__parameterized2_4\ is
  port (
    loop_Bit : out STD_LOGIC;
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of \zsys_fit_timer_0_0_Divide_part__parameterized2_4\ : entity is "Divide_part";
end \zsys_fit_timer_0_0_Divide_part__parameterized2_4\;

architecture STRUCTURE of \zsys_fit_timer_0_0_Divide_part__parameterized2_4\ is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity \zsys_fit_timer_0_0_Divide_part__parameterized2_5\ is
  port (
    loop_Bit : out STD_LOGIC;
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of \zsys_fit_timer_0_0_Divide_part__parameterized2_5\ : entity is "Divide_part";
end \zsys_fit_timer_0_0_Divide_part__parameterized2_5\;

architecture STRUCTURE of \zsys_fit_timer_0_0_Divide_part__parameterized2_5\ is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity \zsys_fit_timer_0_0_Divide_part__parameterized2_6\ is
  port (
    loop_Bit : out STD_LOGIC;
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of \zsys_fit_timer_0_0_Divide_part__parameterized2_6\ : entity is "Divide_part";
end \zsys_fit_timer_0_0_Divide_part__parameterized2_6\;

architecture STRUCTURE of \zsys_fit_timer_0_0_Divide_part__parameterized2_6\ is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity zsys_fit_timer_0_0_FIT_timer is
  port (
    Clk : in STD_LOGIC;
    Rst : in STD_LOGIC;
    Interrupt : out STD_LOGIC
  ...
  attribute C_EXT_RESET_HIGH of zsys_fit_timer_0_0_FIT_timer : entity is 1;
  attribute C_FAMILY : string;
  attribute C_FAMILY of zsys_fit_timer_0_0_FIT_timer : entity is "zynq";
  attribute C_INACCURACY : integer;
  attribute C_INACCURACY of zsys_fit_timer_0_0_FIT_timer : entity is 0;
  attribute C_NO_CLOCKS : integer;
  attribute C_NO_CLOCKS of zsys_fit_timer_0_0_FIT_timer : entity is 700000000;
end zsys_fit_timer_0_0_FIT_timer;

architecture STRUCTURE of zsys_fit_timer_0_0_FIT_timer is
  signal CE : STD_LOGIC;
  signal CE_1 : STD_LOGIC;
  signal CE_11 : STD_LOGIC;
  signal CE_13 : STD_LOGIC;
  signal CE_15 : STD_LOGIC;
  signal CE_17 : STD_LOGIC;
  ...
  signal \Using_SRL16s.SRL16s[1].Divide_I_n_12\ : STD_LOGIC;
  ...
  signal loop_Bit_18 : STD_LOGIC;
  signal loop_Bit_2 : STD_LOGIC;
  signal loop_Bit_4 : STD_LOGIC;
  signal loop_Bit_6 : STD_LOGIC;
  signal loop_Bit_8 : STD_LOGIC;
begin
\Using_SRL16s.SRL16s[10].Divide_I\: entity work.\zsys_fit_timer_0_0_Divide_part__parameterized2\
     port map (
      CE => CE,
      CE_0 => CE_17,
      Clk => Clk,
...
\Using_SRL16s.SRL16s[11].Divide_I\: entity work.\zsys_fit_timer_0_0_Divide_part__parameterized2_0\
     port map (
      CE => CE,
      Clk => Clk,
      Clk_En_I_1 => Clk_En_I_1,
      Interrupt => Interrupt,
      Rst => Rst,
      Rst_d1_reg => \Using_SRL16s.SRL16s[1].Divide_I_n_12\,
      loop_Bit => loop_Bit_0
    );
\Using_SRL16s.SRL16s[1].Divide_I\: entity work.zsys_fit_timer_0_0_Divide_part
     port map (
      CE => CE_1,
      Clk => Clk,
      Rst => Rst,
      ...
      \not_First.Out1_reg_8\ => \Using_SRL16s.SRL16s[1].Divide_I_n_12\
    );
\Using_SRL16s.SRL16s[2].Divide_I\: entity work.\zsys_fit_timer_0_0_Divide_part__parameterized0\
     port map (
      CE => CE_3,
      CE_0 => CE_1,
      Clk => Clk,
...
\Using_SRL16s.SRL16s[3].Divide_I\: entity work.\zsys_fit_timer_0_0_Divide_part__parameterized1\
     port map (
      CE => CE_5,
      CE_0 => CE_3,
      Clk => Clk,
...
\Using_SRL16s.SRL16s[4].Divide_I\: entity work.\zsys_fit_timer_0_0_Divide_part__parameterized2_1\
     port map (
      CE => CE_7,
      CE_0 => CE_5,
      Clk => Clk,
...
\Using_SRL16s.SRL16s[5].Divide_I\: entity work.\zsys_fit_timer_0_0_Divide_part__parameterized2_2\
     port map (
      CE => CE_9,
      CE_0 => CE_7,
      Clk => Clk,
...
\Using_SRL16s.SRL16s[6].Divide_I\: entity work.\zsys_fit_timer_0_0_Divide_part__parameterized2_3\
     port map (
      CE => CE_11,
      CE_0 => CE_9,
      Clk => Clk,
...
\Using_SRL16s.SRL16s[7].Divide_I\: entity work.\zsys_fit_timer_0_0_Divide_part__parameterized2_4\
     port map (
      CE => CE_13,
      CE_0 => CE_11,
      Clk => Clk,
...
\Using_SRL16s.SRL16s[8].Divide_I\: entity work.\zsys_fit_timer_0_0_Divide_part__parameterized2_5\
     port map (
      CE => CE_15,
      CE_0 => CE_13,
      Clk => Clk,
...
\Using_SRL16s.SRL16s[9].Divide_I\: entity work.\zsys_fit_timer_0_0_Divide_part__parameterized2_6\
     port map (
      CE => CE_17,
      CE_0 => CE_15,
      Clk => Clk,
...
entity zsys_fit_timer_0_0 is
  ...
  attribute NotValidForBitStream of zsys_fit_timer_0_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of zsys_fit_timer_0_0 : entity is "zsys_fit_timer_0_0,fit_timer,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of zsys_fit_timer_0_0 : entity is "yes";
  attribute x_core_info : string;
  attribute x_core_info of zsys_fit_timer_0_0 : entity is "fit_timer,Vivado 2018.2";
end zsys_fit_timer_0_0;

architecture STRUCTURE of zsys_fit_timer_0_0 is
  attribute C_EXT_RESET_HIGH : integer;
  ...
  attribute C_NO_CLOCKS : integer;
  attribute C_NO_CLOCKS of U0 : label is 700000000;
  attribute x_interface_info : string;
  attribute x_interface_info of Clk : signal is "xilinx.com:signal:clock:1.0 CLK.Clk CLK";
  attribute x_interface_parameter : string;
  attribute x_interface_parameter of Clk : signal is "XIL_INTERFACENAME CLK.Clk, ASSOCIATED_RESET Rst, FREQ_HZ 100000000, PHASE 0.000, CLK_DOMAIN zsys_processing_system7_0_0_FCLK_CLK0";
...
begin
U0: entity work.zsys_fit_timer_0_0_FIT_timer
     port map (
      Clk => Clk,
      Interrupt => Interrupt,
      Rst => Rst

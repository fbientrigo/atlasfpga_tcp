...
-- Command     : write_vhdl -force -mode funcsim -rename_top zsys_util_ds_buf_ADCLK_0 -prefix
--               zsys_util_ds_buf_ADCLK_0_ zsys_util_ds_buf_0_2_sim_netlist.vhdl
...
entity zsys_util_ds_buf_ADCLK_0_util_ds_buf is
  port (
  ...
  attribute C_BUF_TYPE of zsys_util_ds_buf_ADCLK_0_util_ds_buf : entity is "IBUFDS";
  attribute C_SIZE : integer;
  attribute C_SIZE of zsys_util_ds_buf_ADCLK_0_util_ds_buf : entity is 1;
end zsys_util_ds_buf_ADCLK_0_util_ds_buf;

architecture STRUCTURE of zsys_util_ds_buf_ADCLK_0_util_ds_buf is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity zsys_util_ds_buf_ADCLK_0 is
  port (
    IBUF_DS_P : in STD_LOGIC_VECTOR ( 0 to 0 );
    IBUF_DS_N : in STD_LOGIC_VECTOR ( 0 to 0 );
    IBUF_OUT : out STD_LOGIC_VECTOR ( 0 to 0 )
  ...
  attribute NotValidForBitStream of zsys_util_ds_buf_ADCLK_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of zsys_util_ds_buf_ADCLK_0 : entity is "zsys_util_ds_buf_0_2,util_ds_buf,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of zsys_util_ds_buf_ADCLK_0 : entity is "yes";
  attribute x_core_info : string;
  attribute x_core_info of zsys_util_ds_buf_ADCLK_0 : entity is "util_ds_buf,Vivado 2018.2";
end zsys_util_ds_buf_ADCLK_0;

architecture STRUCTURE of zsys_util_ds_buf_ADCLK_0 is
  ...
  attribute x_interface_parameter of IBUF_OUT : signal is "XIL_INTERFACENAME IBUF_OUT, FREQ_HZ 100000000, PHASE 0.000, CLK_DOMAIN zsys_util_ds_buf_0_2_IBUF_OUT";
begin
U0: entity work.zsys_util_ds_buf_ADCLK_0_util_ds_buf
     port map (
      BUFGCE_CE(0) => '0',
      BUFGCE_I(0) => '0',

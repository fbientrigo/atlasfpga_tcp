...
HD_PWD='C:/Users/victo/Desktop/Vivados/CMB40_v1/CMB40_v1.runs/zsys_util_ds_buf_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log zsys_util_ds_buf_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source zsys_util_ds_buf_0_1.tcl

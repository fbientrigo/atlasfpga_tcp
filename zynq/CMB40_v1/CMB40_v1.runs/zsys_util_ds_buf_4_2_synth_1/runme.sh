...
HD_PWD='C:/Users/victo/Desktop/Vivados/CMB40_v1/CMB40_v1.runs/zsys_util_ds_buf_4_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log zsys_util_ds_buf_4_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source zsys_util_ds_buf_4_2.tcl

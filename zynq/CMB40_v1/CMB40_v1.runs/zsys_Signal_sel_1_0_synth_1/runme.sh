...
HD_PWD='C:/Users/victo/Desktop/Vivados/CMB40_v1/CMB40_v1.runs/zsys_Signal_sel_1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log zsys_Signal_sel_1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source zsys_Signal_sel_1_0.tcl

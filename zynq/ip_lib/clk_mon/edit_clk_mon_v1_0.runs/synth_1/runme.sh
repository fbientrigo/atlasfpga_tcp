...
HD_PWD='C:/Users/victo/Desktop/Vivados/ip_lib/clk_mon/edit_clk_mon_v1_0.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log clk_mon_v1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source clk_mon_v1_0.tcl

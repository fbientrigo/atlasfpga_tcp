...
HD_PWD='C:/Users/victo/Desktop/Vivados/ip_lib/dac_i2c/edit_dac_i2c_v1_0.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log dac_i2c_v1_0.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source dac_i2c_v1_0.tcl -notrace

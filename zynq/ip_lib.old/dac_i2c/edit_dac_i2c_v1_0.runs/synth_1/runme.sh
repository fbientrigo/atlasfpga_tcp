...
HD_PWD='C:/Users/victo/Desktop/Vivados/ip_lib/dac_i2c/edit_dac_i2c_v1_0.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dac_i2c_v1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dac_i2c_v1_0.tcl
